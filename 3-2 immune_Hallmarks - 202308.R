...
Hm <- fgsea::gmtPathways("d:/Work/Data/public_immune/Hallmark/h.all.v2023.1.Hs.symbols.gmt")
...
write.csv(Hallmark_PS_Corr,file = "Hallmark_PS_Corr_v2023.csv",quote = F)


# ============================================================================ #
# 2.picture####
# ============================================================================ #
Hallmark_PS_Corr <- read.csv("Hallmark_PS_Corr_v2023.csv")
...
pdf("immune_mechanism_Hallmark_v2023.pdf",width=12,height = 4) 
