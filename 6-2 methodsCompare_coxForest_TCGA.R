...
# load("d:/Projects/Melanoma_Pyroptosis_new/16.lassoRedgeElastic/RData/lassoRidgeCoef.RData")
# uniCoxSig <- lassoRidgeCoef$geneFeature
...
genelist$PRGs_74[genelist$PRGs_74 %in% rownames(mela_exper) == FALSE]
...
for(j in colnames(multiScore_clinic_merge)[2:13]){
